    ...
    try {
        ...
        return (
            <div className="p-20 text-center">
                <h1 className="text-2xl font-bold mb-4">Debug: Server Error</h1>
                <pre className="bg-red-500/10 p-5 rounded text-left overflow-auto max-w-full inline-block text-xs">
                    {error.message}
                    {"\n\n"}
                    {error.stack}
                </pre>
